...
enum rmq_method {
    ...
    RMQ_METHOD_EXCHANGE_DECLARE     = RMQ_METHOD(RMQ_CLASS_EXCHANGE,  10),
    RMQ_METHOD_EXCHANGE_DECLARE_OK  = RMQ_METHOD(RMQ_CLASS_EXCHANGE,  11),
    RMQ_METHOD_EXCHANGE_DELETE      = RMQ_METHOD(RMQ_CLASS_EXCHANGE,  20),
    RMQ_METHOD_EXCHANGE_DELETE_OK   = RMQ_METHOD(RMQ_CLASS_EXCHANGE,  21),
